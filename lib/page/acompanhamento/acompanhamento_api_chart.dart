...
class AtrasoProcessaomentoApiChart {
  static Future<AtrasoProcessaomento> getAcompanhamento(BuildContext context,Map<String,dynamic> value) async {
   ...
   var fim = value['fim'];
    ...
    var url =
        'http://192.168.:8082/sped-web/services/conteudo/consultar/atraso/processamento?tipo=$usdKey&dataInicial=$ini&dataFinal=$fim';
    ...
    print(mapResponse);
    final AtrasoProcessaomento atrasoProcessaomento = AtrasoProcessaomento.fromJson(mapResponse);
    print(atrasoProcessaomento);


    return atrasoProcessaomento;
  }else{
