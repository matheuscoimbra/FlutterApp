...
class AcompanhamentoBloc{
  ...
  Future<Acompanhamento> loaldData(BuildContext context, Map<String,dynamic> value) async{
    try {
      Acompanhamento acompanhamento = await AcompanhamentoApi.getAcompanhamento(context, value);
